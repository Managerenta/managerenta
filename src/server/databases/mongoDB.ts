...
declare global {
	...
	var __managerentaMongooseCache: IMongooseCache | undefined;
}

const cache: IMongooseCache = global.__managerentaMongooseCache ?? {
	conn: null,
	promise: null,
};

if (!global.__managerentaMongooseCache) {
	global.__managerentaMongooseCache = cache;
}

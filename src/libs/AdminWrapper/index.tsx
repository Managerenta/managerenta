export { default as AdminAnalyticsWrapper } from "./pages/Analytics";
export { default as AdminAuditWrapper } from "./pages/Audit";
export { default as AdminIamWrapper } from "./pages/Iam";
